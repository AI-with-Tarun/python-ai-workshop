...
from agno.tools.mcp import MCPTools #pip install mcp

QDRANT_URL = ""
QDRANT_API_KEY = ""
COLLECTION_NAME = "vibecoding"
...
if __name__ == "__main__":
    query = """
    give code to write neural network i.e., CNN with 3 hidden layers (64,128,256) and 1 output layer. 
    Also add MaxPooling2D and Normalization after each hidden layer.
